...
export default function StudentsPage() {
  ...
  if (selectedClassQuery.isError || studentsQuery.isError) {
    return <Alert type="error" showIcon message="Não foi possível carregar os alunos da turma." />
  }
  ...
  const classFinished = selectedClass ? isClassFinished(selectedClass.finishDate) : false
  const classRemainingDays = selectedClass ? getDaysUntilClassEnd(selectedClass.finishDate) : 0
      ...
      <Row gutter={[16, 16]} align="top">
          ...
          <Card>
            <Space direction="vertical" size={8} style={{ width: '100%' }}>
              ...
              <Space size={8}>
                <ClockCircleOutlined />
                <Typography.Text type="secondary">
                  {selectedClass ? toPeriodLabel(selectedClass.initDate, selectedClass.finishDate) : '-'}
                </Typography.Text>
              </Space>
        ...
        <Col xs={24} lg={18}>
          <Space direction="vertical" size={16} style={{ width: '100%' }}>
            ...
            {students.length === 0 ? (
              <Empty description="Nenhum aluno encontrado para esta turma." />
            ) : (
              <Card>
                {isMobile ? (
                  <List
                          ...
                          <List.Item.Meta
                            ...
                            description={
                              <Space direction="vertical" size={2}>
                                ...
                                <Space size={6}>{renderStudentClassesShortcut(student)}</Space>
                              </Space>
                            }
                          />
                        </List.Item>
                  ...
                  <Table rowKey="id" dataSource={students} columns={desktopColumns} pagination={false} />
                )}
